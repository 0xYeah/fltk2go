...
// #cgo linux,amd64 CPPFLAGS: -I${SRCDIR}/../libs/fltk/linux/amd64 -I${SRCDIR}/../libs/fltk/include -I${SRCDIR}/../libs/fltk/include/FL/images -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D_THREAD_SAFE -D_REENTRANT
